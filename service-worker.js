...
const CACHE = 'rs-wirkstoff-v1.1.0';
const ASSETS = [
  './',
  './index.html',
...
self.addEventListener('fetch', function (e) {
  ...
  if (isDoc) {
    /* Network first — neue Version gewinnt immer, Cache nur als Notnagel offline */
    e.respondWith(
  ...
  /* Statische Assets: Cache first, im Hintergrund auffrischen */
  e.respondWith(
